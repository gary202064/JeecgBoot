 ...
 */
@Data
@TableName("hn_equipment_override_price")
@Schema(name="hn_equipment_override_price", description="设备专属单价表")
public class HnEquipmentOverridePrice implements Serializable {
