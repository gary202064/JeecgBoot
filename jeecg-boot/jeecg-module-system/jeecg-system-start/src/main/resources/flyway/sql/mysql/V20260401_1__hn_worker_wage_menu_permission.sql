...
-- 8. 设备专属单价管理 (hn_equipment_override_price)

INSERT INTO sys_permission(id, parent_id, name, url, component, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_route, is_leaf, keep_alive, hidden, hide_tab, description, status, del_flag, rule_flag, create_by, create_time, update_by, update_time, internal_or_external)
SELECT '177502397029509', '177502397029501', '设备专属单价管理', '/workwage/hnEquipmentOverridePriceList', 'workwage/equipmentOverridePrice/HnEquipmentOverridePriceList', NULL, NULL, 0, NULL, '1', 8.00, 0, NULL, 1, 1, 1, 0, 0, NULL, '1', 0, 0, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '177502397029509');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702950902', '177502397029509', '添加设备专属单价管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_equipment_override_price:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702950902');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702950903', '177502397029509', '编辑设备专属单价管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_equipment_override_price:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702950903');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702950904', '177502397029509', '删除设备专属单价管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_equipment_override_price:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702950904');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702950905', '177502397029509', '批量删除设备专属单价管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_equipment_override_price:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702950905');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702950906', '177502397029509', '导出excel设备专属单价管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_equipment_override_price:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702950906');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702950907', '177502397029509', '导入excel设备专属单价管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_equipment_override_price:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702950907');

INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702950909', 'f6817f48af4fb3af11b9e8bf182f618b', '177502397029509', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702950909');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702950911', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702950902', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702950911');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702950912', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702950903', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702950912');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702950913', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702950904', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702950913');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702950914', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702950905', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702950914');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702950915', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702950906', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702950915');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702950916', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702950907', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702950916');
...
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702951502', '177502397029515', '添加设备类型工序关联管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_type_process:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951502');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702951503', '177502397029515', '编辑设备类型工序关联管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_type_process:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951503');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702951504', '177502397029515', '删除设备类型工序关联管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_type_process:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951504');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702951505', '177502397029515', '批量删除设备类型工序关联管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_type_process:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951505');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702951506', '177502397029515', '导出excel设备类型工序关联管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_type_process:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951506');

INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external)
SELECT '17750239702951507', '177502397029515', '导入excel设备类型工序关联管理', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_type_process:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0
WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951507');

INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702951509', 'f6817f48af4fb3af11b9e8bf182f618b', '177502397029515', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702951509');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702951511', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702951502', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702951511');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702951512', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702951503', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702951512');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702951513', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702951504', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702951513');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702951514', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702951505', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702951514');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702951515', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702951506', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702951515');
INSERT INTO sys_role_permission (id, role_id, permission_id, data_rule_ids, operate_date, operate_ip)
SELECT '17750239702951516', 'f6817f48af4fb3af11b9e8bf182f618b', '17750239702951507', NULL, '2026-04-01 00:00:00', '127.0.0.1'
WHERE NOT EXISTS (SELECT 1 FROM sys_role_permission WHERE id = '17750239702951516');
