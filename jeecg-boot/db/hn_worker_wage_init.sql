...
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) SELECT '17750239702951102', '177502397029511', '添加工序汇报记录', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_monthly_record:add', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0 WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951102');
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) SELECT '17750239702951103', '177502397029511', '编辑工序汇报记录', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_monthly_record:edit', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0 WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951103');
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) SELECT '17750239702951104', '177502397029511', '删除工序汇报记录', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_monthly_record:delete', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0 WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951104');
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) SELECT '17750239702951105', '177502397029511', '批量删除工序汇报记录', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_monthly_record:deleteBatch', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0 WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951105');
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) SELECT '17750239702951106', '177502397029511', '导出excel工序汇报记录', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_monthly_record:exportXls', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0 WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951106');
INSERT INTO sys_permission(id, parent_id, name, url, component, is_route, component_name, redirect, menu_type, perms, perms_type, sort_no, always_show, icon, is_leaf, keep_alive, hidden, hide_tab, description, create_by, create_time, update_by, update_time, del_flag, rule_flag, status, internal_or_external) SELECT '17750239702951107', '177502397029511', '导入excel工序汇报记录', NULL, NULL, 0, NULL, NULL, 2, 'hnworkerwage:hn_monthly_record:importExcel', '1', NULL, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2026-04-01 00:00:00', NULL, NULL, 0, 0, '1', 0 WHERE NOT EXISTS (SELECT 1 FROM sys_permission WHERE id = '17750239702951107');
