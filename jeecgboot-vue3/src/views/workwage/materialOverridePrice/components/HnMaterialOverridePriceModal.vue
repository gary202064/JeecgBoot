<template>
  <BasicModal v-bind="$attrs" @register="registerModal" destroyOnClose :title="title" :width="800" @ok="handleSubmit">
    <BasicForm @register="registerForm" name="HnMaterialOverridePriceForm" />
  </BasicModal>
</template>
...
<script lang="ts" setup>
  ...
  import { formSchema } from '../HnMaterialOverridePrice.data';
  import { saveOrUpdate } from '../HnMaterialOverridePrice.api';
