...
enum Api {
  list = '/hnworkerwage/hnTypeProcess/list',
  save = '/hnworkerwage/hnTypeProcess/add',
  edit = '/hnworkerwage/hnTypeProcess/edit',
  deleteOne = '/hnworkerwage/hnTypeProcess/delete',
  deleteBatch = '/hnworkerwage/hnTypeProcess/deleteBatch',
  importExcel = '/hnworkerwage/hnTypeProcess/importExcel',
  exportXls = '/hnworkerwage/hnTypeProcess/exportXls',
}
