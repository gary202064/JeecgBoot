<template>
  <BasicModal v-bind="$attrs" @register="registerModal" destroyOnClose :title="title" :width="800" @ok="handleSubmit">
    <BasicForm @register="registerForm" name="HnWorkerProcessAbilityForm" />
  </BasicModal>
</template>
...
<script lang="ts" setup>
  ...
  import { formSchema } from '../HnWorkerProcessAbility.data';
  import { saveOrUpdate } from '../HnWorkerProcessAbility.api';
