...
export const columns: BasicColumn[] = [
  ...
  { title: '产线', align: 'center', dataIndex: 'lineId_dictText' },
...
export const formSchema: FormSchema[] = [
  ...
  { label: '所属年月', field: 'yearMonth', required: true, component: 'Input', componentProps: { placeholder: '请输入所属年月，如：2026-03' } },
  ...
  { label: '产线', field: 'lineId', required: true, component: 'JDictSelectTag', componentProps: { dictCode: 'production_line', placeholder: '请选择产线' } },
...
export const superQuerySchema = {
  yearMonth: { title: '所属年月', order: 0, view: 'text' },
