<template>
  <BasicModal v-bind="$attrs" @register="registerModal" destroyOnClose :title="title" :width="800" @ok="handleSubmit">
    <BasicForm @register="registerForm" name="HnMaterialDimensionForm" />
  </BasicModal>
</template>
...
<script lang="ts" setup>
  ...
  import { formSchema } from '../HnMaterialDimension.data';
  import { saveOrUpdate } from '../HnMaterialDimension.api';
